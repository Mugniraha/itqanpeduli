            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-700 dark:text-gray-400">
                ...
                <tbody>
                    @foreach ($berita as $item)
                        <tr class="{{ $loop->odd ? 'odd:bg-white odd:dark:bg-gray-900' : 'even:bg-gray-50 even:dark:bg-gray-800' }} border-b dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 flex">
                                <a href="{{ route('edit-berita', $item->id) }}" class="font-normal text-blue-600 dark:text-blue-500 hover:underline">
