...
<div class="p-4 ">
    <div class="subheader text-white my-8">
        ...
        <form class="px-8 mt-6 bg-white rounded-lg" method="POST" action="{{ url('/berita') }}">
            ...
            <div class="pt-8">
                <button type="submit"
                    class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                    Submit
                </button>
            </div>
        </form>
