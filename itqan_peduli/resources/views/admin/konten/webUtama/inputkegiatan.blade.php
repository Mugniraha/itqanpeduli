    ...
    <div class="p-4 ">
        <div class="subheader text-white my-8">
            ...
            <form class="px-8 mt-6 bg-white rounded-lg">
                ...
                <div class=" pt-4">
                    <label for="CTA" class="block mb-2 text-sm font-medium text-gray-900">CTA (call to action)</label>
                    <input type="text" id="CTA"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="Name Button CTA" required />
                </div>
                <div class=" pt-4">
                    <label for="direct_link" class="block mb-2 text-sm font-medium text-gray-900">Direct Link</label>
