        ...
        <div class="subheader text-white my-8">
            <div class="welcome flex justify-between bg-green-700 me-30 w-full py-8 px-4 rounded-lg">
                ...
                <div class="kanan my-auto">
                    <a type="button" href="{{ url('/inputkegiatan') }}" class="text-green-700 bg-white p-10 border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-normal rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
                        Tambah Gambar
                    </a>
                </div>
            </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-700">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-4">
                                @if($kegiatan->foto)
                                    <img src="{{ asset('storage/' . $kegiatan->foto) }}" width="50" />
                                @endif
                            </td>
                            <td class="px-6 py-4">{{ $kegiatan->created_at->format('d M Y') }}</td>
                            <td class="flex px-6 py-9">
