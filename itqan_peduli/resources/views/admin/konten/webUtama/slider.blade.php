        ...
        <div class="subheader text-white my-8">
            <div class="welcome flex justify-between bg-green-700 me-30 w-full py-8 px-4 rounded-lg">
                ...
                <div class="kanan my-auto">
                    <a href="{{ route('banner.create') }}" class="text-green-700 bg-white p-10 border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-normal rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
                        Tambah Gambar
                    </a>
                </div>
            </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-700">
                    ...
                    <tbody>
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b">
                            ...
                            <td class="px-6 py-4">
                                <img src="{{ asset('storage/' . $banner->image) }}" alt="" class="size-4">
                            </td>
                            <td class="px-6 py-4 flex">
                                <a href="{{ route('banner.edit', $banner->id) }}" class="font-normal text-blue-600 hover:underline">
                                ...
                                <form action="{{ route('banner.destroy', $banner->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('DELETE')
                                <button type="submit">
