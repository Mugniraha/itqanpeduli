        ...
        <div class="subheader text-white my-8">
            <div class="welcome  bg-green-700 me-30 w-full py-6 px-4 rounded-xl">
                <div class="kanan my-auto">
                    <a type="button" href="{{ route('articleCategory.index') }}"
            ...
            <form method="POST" action="{{ route('articleCategory.update', $articleCategory->id ) }}" class="px-8 mt-6 bg-white rounded-lg">
                @csrf
                @method('PUT')
                <div class=" pt-4">
                    ...
                    <input type="text" id="kelola_kategori"
                        ...
                        placeholder="Kelola Kategori" value="{{ $articleCategory->name }}" name="name" required />
                </div>
