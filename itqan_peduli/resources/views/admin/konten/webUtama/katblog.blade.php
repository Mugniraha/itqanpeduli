        ...
        <div class="subheader text-white my-8">
            <div class="welcome flex justify-between bg-green-700 me-30 w-full py-8 px-4 rounded-lg">
                ...
                <div class="kanan my-auto">
                    <a type="button" href="{{ url('/inputkatblog') }}" class="text-green-700 bg-white p-10 border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-normal rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
                        Buat Kategori
                    </a>
                </div>
            </div>
