    ...
    <div class="subheader text-white my-8">
        <div class="welcome flex justify-between bg-green-700 me-30 w-full py-8 px-4 rounded-lg">
            ...
            <div class="kanan my-auto">
                <a href="{{ url('/inputpartner') }}" 
                   class="text-green-700 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-normal rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
                    Tambah Partner
                </a>
            </div>
        </div>
        ...
        <table class="w-full text-sm text-left text-gray-700">
            ...
            <tbody>
                ...
                <tr class="odd:bg-white even:bg-gray-50 border-b">
                    ...
                    <td class="px-6 py-4">
                        <img src="{{ asset('storage/' . $partner->gambar) }}" alt="Partner Image" class="w-24 h-32 rounded-lg">
                    </td>
                ...
                @empty
                <tr>
                    <td colspan="3" class="px-6 py-4 text-center text-gray-500">Tidak ada data partner.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
