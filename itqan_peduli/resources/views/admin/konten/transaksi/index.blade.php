...
@section('konten')
    ...
    <div class="relative overflow-x-auto w-full sm:rounded-sm bg-white p-3 mt-4">
            <table id="myTable" class="leading-normal overflow-x-auto stripe text-sm text-left text-gray-500">
