            ...
            <tbody>
                <tr class="odd:bg-gray-100 odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                    ...
                    <td class=" text-black text-base">
                        <div class="flex gap-1">
                            <div href="#" class="text-white text-sm p-1 w-8 px-2 dark:text-black bg-yellow-500 rounded-sm">
                            ...
                            <div href="#" class="text-white text-sm p-1 w-8 px-2 dark:text-black bg-red-600  rounded-sm">
                            ...
                            <div href="#" class="text-white text-sm p-1 w-8 px-2 dark:text-black bg-green-600  rounded-sm">
                                <svg class="w-[18px] h-[18px] text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
