                ...
                <tr class="odd:bg-gray-100 odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b">
                    ...
                    <td class="px-6 py-4 text-black text-base">
                        ...
                        @elseif ($row->status === 'pending')
                            Menunggu
                        @endif
                        {{-- @if ($row->status === 'Success' || $row->status === 'Terverivikasi')
                    ...
                    <td class=" text-black text-base">
                        <a href="{{route('transaksi.showTransaksiOnlineManual', $row->id)}}" class="text-white text-sm p-1 px-2 w-11/12 text-center bg-green-700 rounded-sm md:flex-col md:flex">
                            Lihat Detail
                        </a>
                    </td>
                </tr>
