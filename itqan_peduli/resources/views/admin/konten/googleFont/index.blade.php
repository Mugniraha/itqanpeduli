...
@section('konten')
    ...
    <div class="mb-10">
        <form action="">
            <div class="mt-8 mx-3">
                <label for="message" class="block mb-2 text-base font-base text-gray-900">Kode Google Font</label>
                <textarea id="message" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500" placeholder=""></textarea>
            </div>
