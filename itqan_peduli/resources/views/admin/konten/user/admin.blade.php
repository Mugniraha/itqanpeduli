...
@section('konten')
    <div class="py-3 bg-green-700 rounded-xl">
        <div class=" p-5 flex justify-between">
            ...
            <div
                ...
                <a href="{{ route('users.create') }}" class="text-green-700">Tambah User</a>
            </div>
        </div>
    </div>
    ...
    <div class="flex mt-10">
        ...
        <div class="bg-white p-2 text-blue-600 font-normal">
            <a class="mx-3" href="{{ route('users.fundraiser') }}">Fundraiser</a>
        </div>
    </div>
    <div class="relative overflow-x-auto sm:rounded-sm p-5">
        <table id="myTable"
            class="min-w-full leading-normal stripe w-full text-sm text-left rtl:text-right text-gray-500">
                        ...
                        <td class="px-6 py-4 text-black text-base w-1/5">
                            <div class="flex gap-1">
                                <a href="{{ route('users.edit', $user->id) }}"
                                    class="text-white text-sm p-1 w-8 px-2 bg-yellow-500 rounded-sm">
                                    <svg class="w-[18px] h-[18px] text-gray-800" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"
                                        viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
