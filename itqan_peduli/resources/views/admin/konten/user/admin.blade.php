                    ...
                    <tr class="odd:bg-gray-100 odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b">
                        ...
                        <td class="px-6 py-4 text-black text-base w-1/5">
                            <div class="flex gap-1">
                                <a href="{{ route('user.edit', $admin->id) }}" class="text-white text-sm p-1 w-8 px-2 bg-yellow-500 rounded-sm">
                                    <svg class="w-[18px] h-[18px] text-gray-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
