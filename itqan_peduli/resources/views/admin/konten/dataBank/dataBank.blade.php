            ...
            <div class="flex flex-col p-5">
                <div class="flex justify-between">
                    <diV class="md:flex gap-3">
                        ...
                        <div class="">
                            <h5 class="text-md font-medium text-gray-900">Nama Bank</h5>
                            <p class="text-sm text-gray-500">No. Rekening</p>
                            <p class="mb-3 text-sm text-gray-500">A.N. Yayasan Baitul Maal Itqan</p>
                        </div>
                    </diV>
                            ...
                            <ul class="py-2" aria-labelledby="dropdownButton">
                                <li>
                                    <div class="flex items-center px-5 mb-1">
                                        <svg class="w-[15px] h-[15px] text-gray-800" aria-hidden="true"
                                        ...
                                        <a href="#"
                                            class="pl-1 block text-sm text-gray-700 hover:bg-gray-100">Edit</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="flex items-center px-5">
                                        ...
                                        <a href="#"
                                            class="pl-1 block text-sm text-red-600 hover:bg-gray-100">Delete</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
