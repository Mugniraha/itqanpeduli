        ...
        <div class="bawah bg-white shadow-md my-10 p-5 rounded-lg">
            ...
            <div class="w-full max-w-[12rem] mt-4">
                <div class="relative">
                    ...
                    <button id="nominal-copy-button" class="absolute end-2 top-1/2 -translate-y-1/2 text-gray-500 rounded-lg px-3 inline-flex items-center justify-center">
                    ...
                    <div id="tooltip-nominal-copy-button" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip">
            ...
            <input class="block w-full my-2 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" id="multiple_files" type="file" multiple>
