            ...
            <div class="atas flex justify-between mb-12">
                <div class="kiri flex">
                    ...
                    <form class="max-w-sm ms-2">
                        <select id="perPage" name="perPage" class="bg-gray-50 border border-green-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-16 p-1 dark:bg-gray-700 dark:border-green-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="kanan">
                    <form method="GET" action="{{ route('fundraisers.index') }}" class="flex items-center max-w-sm mx-auto">
                        ...
                        <div class="relative w-full">
                            <input type="text" name="search" id="search" value="{{ request('search') }}" class="h-8 bg-gray-50 border border-green-300 text-gray-900 text-sm rounded-lg focus:ring-green-800 focus:border-green-800 block w-full ps-2 p-1.5 dark:bg-gray-700 dark:border-green-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-800 dark:focus:border-green-800" placeholder="Search fundraisers" />
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        @foreach ($fundraisers as $fundraiser)
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-green-700">
                                ...
                                <td class="px-6 py-4 flex">
                                    <a href="{{ route('fundraisers.edit', $fundraiser->id) }}" class="font-normal text-blue-600 dark:text-blue-500 hover:underline">
                                    ...
                                    <form action="{{ route('fundraisers.destroy', $fundraiser->id) }}" method="POST" class="ms-2">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="font-normal text-red-600 dark:text-red-500 hover:underline">
