...
<div class="grid md:grid-cols-3 sm:grid-cols-1 w-full gap-6">
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
        <div class="flex flex-col p-5">
            <div class="flex justify-between">
                ...
                <div class="flex items-start px-4 pt-4">
                    <button id="dropdownButton" data-dropdown-toggle="dropdown" class="inline-block text-gray-500 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg text-sm p-1.5" type="button">
                        ...
                        <svg class="w-5 h-5" aria-hiddexn="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 3">
                    ...
                    <div id="dropdown" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                        ...
                        <li>
                            <div class="flex items-center px-5 mb-1">
                                ...
                                <a href="#" class="pl-1 block text-sm text-gray-700 hover:bg-gray-100">Edit</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center px-5">
                                ...
                                <a href="#" class="pl-1 block text-sm text-red-600 hover:bg-gray-100">Delete</a>
                            </div>
                        </li>
                        </ul>
                    </div>
            ...
            <h5 class="text-md font-medium text-gray-900">Judul</h5>
            <span class="mb-3 text-sm text-gray-500">Kategori</span>
            ...
            <div class="flex items-center mt-4 md:mt-6">
                <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Preview</a>
            </div>
        </div>
    </div>
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
