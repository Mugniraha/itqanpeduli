...
<div class="grid md:grid-cols-3 sm:grid-cols-1 w-full gap-6">
    ...
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col p-5">
            ...
            <h5 class="text-md font-medium text-gray-900 dark:text-white">Judul</h5>
            <span class="mb-3 text-sm text-gray-500 dark:text-gray-400">Kategori</span>
            ...
            <div class="flex items-center mt-4 md:mt-6">
                <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Preview</a>
            </div>
        </div>
    </div>
    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div id="dropdown" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        ...
                        <li>
                            <div class="flex items-center px-5">
                                ...
                                <a href="#" class="pl-1 block text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Restored</a>
                            </div>
                        </li>
                        </ul>
                    </div>
