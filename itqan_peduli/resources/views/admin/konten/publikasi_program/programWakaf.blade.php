        ...
        <div class="subheader text-white my-8">
            ...
            <form class="px-8 mt-6 bg-white rounded-lg">
                ...
                <div class="pt-4">
                    ...
                    <input
                        class="block  text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer "
                ...
                <div class="pt-4">
                    <label for="labelDonasi" class="block mb-2 text-sm font-medium text-gray-900">Satuan / Unit</label>
                    <input type="text" id="labelDonasi"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        placeholder="misal: m2/m/kg/dll" required />
                </div>
                <div class="pt-4">
                    <label for="labelDonasi" class="block mb-2 text-sm font-medium text-gray-900">Harga per Unit</label>
                    <input type="text" id="labelDonasi"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded- mdfocus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
