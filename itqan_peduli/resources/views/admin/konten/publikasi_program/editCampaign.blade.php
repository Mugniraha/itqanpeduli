        ...
        <div class="subheader text-white my-8">
            ...
            <form method="POST" action="{{ route('campaign.update', $campaign->id) }}" enctype="multipart/form-data" class="px-8 mt-6 bg-white rounded-lg">
                ...
                <div class=" pt-4">
                    ...
                    <select id="kategori"name="category" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                ...
                <div class="pt-4">
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <label for="unlimited-checkbox" class="ms-2 text-sm font-normal text-gray-400">Program Unlimited ?</label>
                        @else
                ...
                <label for="target" id="target-label" class="block mb-2 text-sm font-medium text-gray-900">Target
                    (Rp)</label>
                <input type="text" id="target"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="Target" name="target" required min="0" value="{{ $campaign->target }}" />

                <label for="deadline" id="deadline-label" class="block mb-2 text-sm font-medium text-gray-900">Batas
                    Waktu</label>
                ...
                <div class="pt-4">
                    ...
                    <div id="nominal-container" class="hidden">
                        <label for="nominal1" class="block mb-2 text-sm font-medium text-gray-900">Nominal Custom (Optional)</label>
                ...
                <div class="pt-4 flex justify-end">
                    ...
                    {{-- <div class="kanan my-auto"> --}}
                    <button type="submit"
                        class="text-white bg-green-600 border border-green-300 focus:outline-none hover:bg-green-700 focus:ring-4 focus:ring-green-100 font-semibold rounded-lg text-xl pt-1.5 w-24 h-11 text-center">
                        Simpan
                    </button>
                    {{-- </div> --}}
                </div>
