        ...
        <div class="subheader text-white my-8">
            <div class="welcome flex justify-between bg-green-700 me-30 w-full py-8 px-4 rounded-lg">
                ...
                <div class="kanan my-auto">
                    <a href="{{ route('kategori.create') }}" class="whitespace-nowrap text-green-700 bg-white p-10 border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-normal rounded-lg text-sm px-5 py-2.5 me-2 mb-2">
                        Buat Kategori
                    </a>
                </div>
            </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-700">
                    ...
                    <tbody>
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b">
                            ...
                            <td class="px-6 py-4">
                                <img class="flex-none w-[25px] h-[25px] object-cover" src="{{ asset('storage/' . $kategori->icon) }}" alt="{{ $kategori->name }}" class="">
                            </td>
                            <td class="px-6 py-4 flex">
                                <a href="{{ route('kategori.edit', $kategori->id) }}" class="font-normal text-blue-600 hover:underline">
                                ...
                                <button type="button" data-modal-target="popup-modal-{{ $kategori->name}}" data-modal-toggle="popup-modal-{{ $kategori->name}}">
                        ...
                        <div id="popup-modal-{{ $kategori->name}}" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow">
                                    <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="popup-modal-{{ $kategori->name}}">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <form method="POST" action="{{ route('kategori.destroy', $kategori->id) }}">
                                            ...
                                            <button type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100" data-modal-hide="popup-modal-{{ $kategori->id }}">
                                                No, cancel
                                            </button>
                                        </form>
                                    </div>
