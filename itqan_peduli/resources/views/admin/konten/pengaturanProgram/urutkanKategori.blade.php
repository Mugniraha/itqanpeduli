    ...
    <ul id="items" class="space-y-2">
        <li>
            <div class="md:flex items-center w-full p-3 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
                ...
                <div class="">
                    <p class="mb-1 text-xl font-bold tracking-tight text-gray-900">Nama Kategori 1</p>
        ...
        <li>
            <div class="md:flex items-center w-full p-3 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
                ...
                <div class="">
                    <p class="mb-1 text-xl font-bold tracking-tight text-gray-900">Nama Kategori 2</p>
                    <p class="font-normal text-gray-700">Drag untuk memindahkan Kategori.</p>
                </div>
            </div>
        </li>
        <li>
            <div class="md:flex items-center w-full p-3 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
                ...
                <div class="">
                    <p class="mb-1 text-xl font-bold tracking-tight text-gray-900">Nama Kategori 3</p>
                    <p class="font-normal text-gray-700">Drag untuk memindahkan Kategori.</p>
                </div>
            </div>
        </li>
        <li>
            <div class="md:flex items-center w-full p-3 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
                ...
                <div class="">
                    <p class="mb-1 text-xl font-bold tracking-tight text-gray-900">Nama Kategori 4</p>
                    <p class="font-normal text-gray-700">Drag untuk memindahkan Kategori.</p>
                </div>
            </div>
        </li>
