...
<<<<<<< HEAD
        <form action="{{ route('mail-settings.store') }}" method="POST">
            @csrf
            <div class="my-8">
                <label for="mail_mailer" class="block mb-2 text-sm text-gray-900">Mail Mailer</label>
            ...
            <div class="my-8">
                <label for="mail_host" class="block mb-2 text-sm text-gray-900">Mail Host</label>
                <input type="text" id="mail_host" name="mail_host"
                    value="{{ old('mail_host', $settings->mail_host ?? '') }}"
                    class="block w-full p-2 text-gray-900 border border-gray-300 rounded bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="my-8">
                <label for="mail_port" class="block mb-2 text-sm text-gray-900">Mail Port</label>
                <input type="text" id="mail_port" name="mail_port"
                    value="{{ old('mail_port', $settings->mail_port ?? '') }}"
                    class="block w-full p-2 text-gray-900 border border-gray-300 rounded bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="my-8">
                <label for="mail_username" class="block mb-2 text-sm text-gray-900">Mail Username</label>
                <input type="text" id="mail_username" name="mail_username"
                    value="{{ old('mail_username', $settings->mail_username ?? '') }}"
                    class="block w-full p-2 text-gray-900 border border-gray-300 rounded bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="my-8">
                <label for="mail_password" class="block mb-2 text-sm text-gray-900">Mail Password</label>
                <input type="text" id="mail_password" name="mail_password"
                    value="{{ old('mail_password', $settings->mail_password ?? '') }}"
                    class="block w-full p-2 text-gray-900 border border-gray-300 rounded bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="my-8">
                <label for="mail_encryption" class="block mb-2 text-sm text-gray-900">Mail Encryption</label>
                <input type="text" id="mail_encryption" name="mail_encryption"
                    value="{{ old('mail_encryption', $settings->mail_encryption ?? '') }}"
                    class="block w-full p-2 text-gray-900 border border-gray-300 rounded bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="my-8">
                <label for="mail_from_address" class="block mb-2 text-sm text-gray-900">Mail From Address</label>
                <input type="text" id="mail_from_address" name="mail_from_address"
                    value="{{ old('mail_from_address', $settings->mail_from_address ?? '') }}"
                    class="block w-full p-2 text-gray-900 border border-gray-300 rounded bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="my-8">
                <label for="mail_from_name" class="block mb-2 text-sm text-gray-900">Mail From Name</label>
