...
<<<<<<< HEAD
                ...
                <input type="text" id="mediaberbagi_host" name="mediaberbagi_host"
                    ...
                    class="block w-full p-2.5 text-gray-900 border border-gray-300 rounded bg-gray-50 text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="mb-5">
                <label for="mediaberbagi_access_key" class="block mb-2 text-md text-gray-900 dark:text-white">MediaBerbagi Access Key</label>
