...
<body class="bg-gray-200 max-w-[512px] mx-auto">
    <div class="p-4 bg-white">
        ...
        <div class=" mt-10">
            <div class="text-2xl font-bold text-black">Login</div>
            <div class="text-lg text-black">Masuk untuk menikmati kemudahan berinvestasi akhirat dan
                akses fitur lainnya.
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="relative mt-6">
                    ...
                    autofocus autocomplete="username" placeholder="contoh: mediaberbagi@gmail.com"
                ...
                <div class="text-end">
                    <a href="{{ route('password.request') }}" type="button"
                        class="text-end font-semibold text-sm mt-4 text-green-700">Lupa Kata Sandi ?</a>
                </div>
                <button type="submit"
                    class="px-6 py-3.5  w-full mt-1.5  text-base font-medium text-white inline-flex items-center border border-green-800 bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-100 rounded-2xl">
                    <p class="text-white mx-auto text-xl text-center font-semibold">{{ __('Log in') }}</p>
                </button>
            </form>
            ...
            <div class="flex justify-center mx-auto my-10 gap-24 ">
                ...
                <svg class="w-10 h-10 text-green-800 border border-white rounded-full shadow-lg" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                    viewBox="0 0 24 24">
