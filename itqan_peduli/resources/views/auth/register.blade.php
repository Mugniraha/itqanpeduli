    ...
    <div class="p-4 bg-white">
        ...
        <div class=" isi">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="relative mt-6">
                    <label for="phone_number" value="{{ __('Phone_number') }}"
                        class="absolute -top-3 left-3 bg-white px-1 font-semibold text-sm text-gray-600">Nomor Telepon</label>
                    <input type="text" id="phone_number" name="phone_number" :value="old('phone_number')" required autocomplete="phone_number" placeholder="contoh: 0821021xx-xxxx"
                        class="w-full py-3 px-4 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-transparent">
                </div>
                <div class="relative mt-6">
                    <label for="email" value="{{ __('Email') }}"
                        class="absolute -top-3 left-3 bg-white px-1 font-semibold text-sm text-gray-600">Alamat Email</label>
                    <input type="email" id="email" name="email" :value="old('email')" required autocomplete="username" placeholder="contoh: mediaberbagi@gmail.com"
                        class="w-full py-3 px-4 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-green-600 focus:border-transparent">
                </div>
                <div class="relative mt-6">
                ...
                <button type="submit"
                    ...
                    <p class="text-white mx-auto text-xl text-center font-semibold">{{ __('Register') }}</p>
                </button>
            </form>
