    ...
    <div class="w-full min-h-screen bg-white overflow-hidden">
        <div class="relative">
            <div class="absolute inset-0 flex justify-center items-center">
                <div class="w-[630px] h-[600px] bg-green-600 rounded-full z-0 -mx-[256px]"></div>
            </div>
        </div>
        ...
        <div class="fixed z-40 w-[480px] h-auto mx-auto max-w-lg -translate-x-1/2 bottom-4 left-1/2">
            <div class="bg-white border border-gray-200 rounded-xl ">
                ...
                <a href="/home1" type="button" class="inline-flex flex-col items-center justify-center px-5 py-4 hover:bg-gray-50 group">
