    ...
    <div class="w-full min-h-screen bg-white overflow-hidden">
        <div class="relative">
            ...
            <div class="relative z-10">
                <div id="navBar" class="fixed bg-slate-50 w-[512px] h-18 flex content-center justify-between">
                ...
                <div id="indicators-carousel" class="relative w-4/5 h-40 mx-auto" data-carousel="static">
                    <!-- Carousel wrapper -->
                    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                        <!-- Item 1 -->
                        <div class="hidden duration-700 h-40 ease-in-out" data-carousel-item="active">
                        ...
                        <!-- Item 2 -->
                        <div class="hidden duration-700 h-40 ease-in-out" data-carousel-item>
