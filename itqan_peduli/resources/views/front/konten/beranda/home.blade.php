...
<div class="mx-8">
    <div class="">
        ...
        <div class="flex my-3 w-full bg-white border border-gray-200 rounded-lg shadow">
            <img class="rounded-s-lg w-1/3 object-cover" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="Card Image 1" />
            <div class="p-5 w-2/3">
                <p class="mb-3 font-normal text-gray-700 line-clamp-2">Cianjut erduka: 200 lebih meninggal dunia. cianjur berduka</p>
                <div class="w-full bg-gray-200 rounded-full h-2.5 mb-4">
...
<div class="grid gap-2 mx-8">
    ...
    <div class="grid items-center justify-center w-full p-5 gap-1 bg-white border border-gray-200 rounded-lg shadow">
        {{-- <svg class="w-12 h-12 mx-auto text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
