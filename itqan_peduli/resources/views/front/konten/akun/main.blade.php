...
@section('konten')
    <div x-data="{ open: false }" class="relative z-20 px-4 pt-4 pb-28">
        ...
        <div class="flex flex-col py-3 items-center gap-4">
            <img class="w-24 h-24 rounded-full object-cover" src="{{ Storage::url(Auth::user()->profile_photo_path) }}" alt="{{ Auth::user()->name }}">
            {{-- <img class="w-24 h-24 rounded-full" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}"> --}}
        ...
        <a href="{{url('/donasi-saya')}}" type="button"
            ...
            <svg class="w-6 h-6 my-auto ms-auto end-0 text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="m9 5 7 7-7 7" />
            </svg>
        ...
        <a href="{{url('/zakat-saya')}}" type="button"
            ...
            <svg class="w-10 h-10  me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 30" fill="none">
                ...
                <circle cx="10.7674" cy="12.3489" r="2.37208" fill="#FBC71E" stroke="black" stroke-width="0.558137" />
                <path
        ...
        <a href="{{ url('duta-amal') }}" type="button"
            ...
            <svg class="w-10 h-10  me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" fill="none">
                ...
                <path d="M20.4007 7.14893L14.5508 8.79892" stroke="black" stroke-width="0.749995" stroke-linecap="round" />
                <path
