...
<div class="relative z-50">
    <div id="navBar" class="z-50 fixed bg-white w-[512px] h-auto flex content-center p-2.5 py-4 pl-6">
        ...
        <div class="flex items-center ml-7">
            <p class="font-semibold">Intruksi Pembayaran</p>
        </div>
    </div>
</div>
...
<div class="mx-8 mt-20 mb-10 grid gap-3">
    ...
    <div class="grid gap-2">
        ...
        <div class="bg-gray-100 rounded-xl p-4 flex justify-between" id="panduan-pembayaran">
            <p class="font-bold text-sm">Lihat Panduan Pembayaran</p>
    ...
    <div class="grid gap-2">
        ...
        target="_blank">
            <div class="bg-white rounded-full">
                <svg class="w-6 h-6 text-blue-800 " xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        href="https://api.whatsapp.com/send?text={{ urlencode('Lihat donasi ini: ' . Request::fullUrl()) }}" 
        target="_blank">
