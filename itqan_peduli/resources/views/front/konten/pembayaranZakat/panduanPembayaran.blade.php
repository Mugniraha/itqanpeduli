            ...
            <div class="relative mt-3 flex justify-center">
                ...
                @else
                    <form id="payment-form" action="{{ route('midtrans.transaction.create', ['id' => $payment->id]) }}" method="POST">
                        @csrf
                        <button id="pay-button" class="bg-green-700 p-3 text-center w-full px-10 rounded-xl text-white" type="button">
                            Bayar Sekarang
                        </button>
                    </form>
                @endif
        ...
        <div class="grid items-center w-full bg-green-100 rounded-xl p-6">
            <div class="text-center grid">
                ...
                <div class="relative mt-3 mx-8 hidden" id="norek-details">
                    ...
                    <input type="text" id="nomor_rekening" class="cursor-default block px-4 pl-20 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white rounded-xl border border-green-600 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-500 focus:outline-none focus:ring-0 focus:border-green-600 peer font-semibold" value="" readonly />
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="uploadBukti-modal">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="#">
                        <div>
                            ...
                            <div class="mt-1 text-sm text-gray-500 dark:text-green-700" id="user_avatar_help">Upload Bukti Pembayaran Anda</div>
                        </div>

                        <button type="submit" class="w-full text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Upload</button>
                    </form>
                </div>
            </div>
        </div>
