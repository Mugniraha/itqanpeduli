...
<div class="mx-8 mt-20 mb-10 grid gap-3">
    ...
    <div class="grid items-center w-full bg-green-100 rounded-xl p-6">
        ...
        <div class="relative mt-3">
            ...
            <input type="text" id="payment-method" class="cursor-default block px-4 pl-20 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white rounded-xl border border-green-600 appearance-none focus:outline-none focus:ring-0 focus:border-green-600 peer font-semibold" value="890399991292" readonly />
