...
@section('konten')
    <div class="bungkus bg-white min-h-screen overflow-auto">
        <div class="header flex">
            ...
            <p class="my-auto font-bold">Donasi Saya</p>
        </div>
        <div class="konten m-5">
            <div class="flex mt-14 justify-center">
                <div id="btnDonasi" class="bg-green-600 p-3 text-center font-semibold text-white w-1/2 rounded-s-2xl cursor-pointer" onclick="showPeriod('Donasi', this)">
                    <p>Riwayat Donasi</p>
                </div>
            ...
            <div class="riwayat my-10">
                <div id="Donasi">
                    ...
                    <div class="bulan flex justify-between my-3">
                        <div class="kiri">
                            <p class="text-sm text-gray-600">3 Donasi</p>
                    ...
                    <div class="my-4 card flex shadow-md p-2 rounded-md">
                        ...
                        <div class="kanan ms-3">
                            ...
                            <p class="font-semibold">Donasi Masjid Polindra</p>
                            <p class="mt-2 text-sm">Jumlah Donasi</p>
