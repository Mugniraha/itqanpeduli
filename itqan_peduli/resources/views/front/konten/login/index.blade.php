    ...
    <div class="p-4 bg-white">
        ...
        <div class=" mt-10">
            ...
            <div class="flex justify-center mx-auto my-10 gap-24 ">
                <svg class="w-10 h-10 border border-white rounded-full text-green-800 shadow-lg"
                ...
                <svg class="w-10 h-10 text-green-800 border border-white rounded-full shadow-lg"
