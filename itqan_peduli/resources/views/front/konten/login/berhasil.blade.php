    ...
    <div class="p-4 bg-white">
        ...
        <div class=" mt-10">
            <div class="flex justify-center">
                <svg class="w-36 h-36 text-green-700" aria-hidden="true"
            ...
            <div class="text-2xl font-bold text-black text-center">Berhasil Ganti Password</div>
            <div class="text-lg text-black justify-center">Jaga baik-baik akun anda, jangan lupa logout
                setelah login.
            </div>

            <a href="{{ url('/login') }}" type="button"
                class="px-6 py-3.5  w-full mt-12 mb-4 text-base font-medium text-white inline-flex items-center border border-green-800 bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-100 rounded-2xl">
