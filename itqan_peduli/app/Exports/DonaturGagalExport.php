...
class DonaturGagalExport implements FromCollection, WithHeadings
{
    /**
     * Mengambil data untuk diekspor dengan status "gagal".
     *
    ...
    public function collection()
    {
        ...
        return DB::table('transaksi_zakat')
            ...
            ->where('transaksi_zakat.status', 'gagal') // Filter untuk status gagal
            ->get();
    }
